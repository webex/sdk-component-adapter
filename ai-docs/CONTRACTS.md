...
| activities-adapter.class | activities-sdk-adapter | `class` | `ActivitiesSDKAdapter extends ActivitiesAdapter` | stable | `src/ActivitiesSDKAdapter.js` | `src/ActivitiesSDKAdapter.js` |
...
| meetings-adapter.class | meetings-sdk-adapter | `class` | `MeetingsSDKAdapter extends MeetingsAdapter` | stable | `src/MeetingsSDKAdapter.js` | `src/MeetingsSDKAdapter.js` |
...
| meetings-adapter.control.settings | meetings-sdk-adapter | `SettingsControl` | `action(meetingContext): Promise<void>`; `display(meetingID): Observable<MeetingControlDisplay>` | stable | `src/MeetingsSDKAdapter/controls/SettingsControl.js` | `src/MeetingsSDKAdapter/controls/SettingsControl.js` |
...
| meetings-adapter.control.switch-camera | meetings-sdk-adapter | `SwitchCameraControl` | `action(meetingContext, deviceId): Promise<void>`; `display(meetingID): Observable<MeetingControlDisplay>` | stable | `src/MeetingsSDKAdapter/controls/SwitchCameraControl.js` | `src/MeetingsSDKAdapter/controls/SwitchCameraControl.js` |
| meetings-adapter.control.switch-microphone | meetings-sdk-adapter | `SwitchMicrophoneControl` | `action(meetingContext, deviceId): Promise<void>`; `display(meetingID): Observable<MeetingControlDisplay>` | stable | `src/MeetingsSDKAdapter/controls/SwitchMicrophoneControl.js` | `src/MeetingsSDKAdapter/controls/SwitchMicrophoneControl.js` |
| meetings-adapter.control.switch-speaker | meetings-sdk-adapter | `SwitchSpeakerControl` | `action(meetingContext, deviceId): Promise<void>`; `display(meetingID): Observable<MeetingControlDisplay>` | stable | `src/MeetingsSDKAdapter/controls/SwitchSpeakerControl.js` | `src/MeetingsSDKAdapter/controls/SwitchSpeakerControl.js` |
| meetings-adapter.controls-barrel.AudioControl | meetings-sdk-adapter | `AudioControl` | `export { AudioControl } from './AudioControl.js'` | stable | `src/MeetingsSDKAdapter/controls/index.js` | `src/MeetingsSDKAdapter/controls/index.js` |
| meetings-adapter.controls-barrel.ExitControl | meetings-sdk-adapter | `ExitControl` | `export { ExitControl } from './ExitControl.js'` | stable | `src/MeetingsSDKAdapter/controls/index.js` | `src/MeetingsSDKAdapter/controls/index.js` |
| meetings-adapter.controls-barrel.JoinControl | meetings-sdk-adapter | `JoinControl` | `export { JoinControl } from './JoinControl.js'` | stable | `src/MeetingsSDKAdapter/controls/index.js` | `src/MeetingsSDKAdapter/controls/index.js` |
| meetings-adapter.controls-barrel.MeetingControl | meetings-sdk-adapter | `MeetingControl` | `export { MeetingControl } from './MeetingControl.js'` | stable | `src/MeetingsSDKAdapter/controls/index.js` | `src/MeetingsSDKAdapter/controls/index.js` |
| meetings-adapter.controls-barrel.RosterControl | meetings-sdk-adapter | `RosterControl` | `export { RosterControl } from './RosterControl.js'` | stable | `src/MeetingsSDKAdapter/controls/index.js` | `src/MeetingsSDKAdapter/controls/index.js` |
| meetings-adapter.controls-barrel.SettingsControl | meetings-sdk-adapter | `SettingsControl` | `export { SettingsControl } from './SettingsControl.js'` | stable | `src/MeetingsSDKAdapter/controls/index.js` | `src/MeetingsSDKAdapter/controls/index.js` |
| meetings-adapter.controls-barrel.SwitchCameraControl | meetings-sdk-adapter | `SwitchCameraControl` | `export { SwitchCameraControl } from './SwitchCameraControl.js'` | stable | `src/MeetingsSDKAdapter/controls/index.js` | `src/MeetingsSDKAdapter/controls/index.js` |
| meetings-adapter.controls-barrel.SwitchMicrophoneControl | meetings-sdk-adapter | `SwitchMicrophoneControl` | `export { SwitchMicrophoneControl } from './SwitchMicrophoneControl.js'` | stable | `src/MeetingsSDKAdapter/controls/index.js` | `src/MeetingsSDKAdapter/controls/index.js` |
| meetings-adapter.controls-barrel.SwitchSpeakerControl | meetings-sdk-adapter | `SwitchSpeakerControl` | `export { SwitchSpeakerControl } from './SwitchSpeakerControl.js'` | stable | `src/MeetingsSDKAdapter/controls/index.js` | `src/MeetingsSDKAdapter/controls/index.js` |
| meetings-adapter.controls-barrel.VideoControl | meetings-sdk-adapter | `VideoControl` | `export { VideoControl } from './VideoControl.js'` | stable | `src/MeetingsSDKAdapter/controls/index.js` | `src/MeetingsSDKAdapter/controls/index.js` |
...
| meetings-adapter.incomingMeeting | meetings-sdk-adapter | `incomingMeeting` | `incomingMeeting(destination: Destination): Observable<Meeting>` | stable; inherited from interface | `@webex/component-adapter-interfaces` | `@webex/component-adapter-interfaces` |
...
| meetings-adapter.meetingControls | meetings-sdk-adapter | `meetingControls` | `Record<string, MeetingControl>` keyed by runtime control string` | stable | `src/MeetingsSDKAdapter.js` | `src/MeetingsSDKAdapter.js` |
...
| memberships-adapter.class | memberships-sdk-adapter | `class` | `MembershipsSDKAdapter extends MembershipsAdapter` | stable | `src/MembershipsSDKAdapter.js` | `src/MembershipsSDKAdapter.js` |
...
| metrics-adapter.class | metrics-sdk-adapter | `class` | `MetricsSDKAdapter extends MetricsAdapter` | stable | `src/MetricsSDKAdapter.js` | `src/MetricsSDKAdapter.js` |
...
| orgs-adapter.class | organizations-sdk-adapter | `class` | `OrganizationsSDKAdapter extends OrganizationsAdapter` | stable | `src/OrganizationsSDKAdapter.js` | `src/OrganizationsSDKAdapter.js` |
...
| people-adapter.class | people-sdk-adapter | `class` | `PeopleSDKAdapter extends PeopleAdapter` | stable; semver via npm bundle | `src/PeopleSDKAdapter.js` | `src/PeopleSDKAdapter.js` |
...
| pkg.default | build | `default` | `export default WebexSDKAdapter` from `src/index.js` | semver via semantic-release | `src/index.js` | `src/index.js` |
| rooms-adapter.class | rooms-sdk-adapter | `class` | `RoomsSDKAdapter extends RoomsAdapter` | stable | `src/RoomsSDKAdapter.js` | `src/RoomsSDKAdapter.js` |
...
| shared.cache.singleton | shared-utilities | `default export` CacheMeOutside singleton` | `Key/value store; also assigned to `WebexSDKAdapter.cache` | stable via facade | `src/cache.js` | `src/cache.js` |
...
| shared.logger.default | shared-utilities | `default export` logger instance` | `Domain debug/error logging` | stable internal | `src/logger.js` | `src/logger.js` |
...
| shared.polyfills.mediaStream | shared-utilities | `MediaStream.prototype.getTracks` shim` | `Legacy browser guard` | stable internal | `src/polyfills.js` | `src/polyfills.js` |
...
| webex-sdk-adapter.default | facade | `default` | `WebexSDKAdapter extends WebexAdapter` | stable | `src/WebexSDKAdapter.js` | `src/WebexSDKAdapter.js` |
